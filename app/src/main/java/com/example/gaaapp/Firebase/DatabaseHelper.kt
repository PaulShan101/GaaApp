...
class DatabaseHelper {
    ...
    fun add(name: String, address: String, score: String) {
        ...
        database.child("users").child(key!!).child("score").setValue(score)
    }

    fun update(_id: String, name: String, address: String, score: String) {
        database.child("users").child(_id).child("name").setValue(name)
        database.child("users").child(_id).child("address").setValue(address)
        database.child("users").child(_id).child("score").setValue(score)
    }
